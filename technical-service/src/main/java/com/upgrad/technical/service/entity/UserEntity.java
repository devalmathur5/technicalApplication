...
public class UserEntity implements Serializable {
    ...
    //Define a private attibute named "lastName" of type String, explictly specify its column name as "LAST_NAME"
    ...
    // explictly specify its column name as "SALT" with notnull constraint and its maximum size should be 200
    @Size(max = 200)
    @NotNull
    @Column(name = "SALT")
    private String salt;
